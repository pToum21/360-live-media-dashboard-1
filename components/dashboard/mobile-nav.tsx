...
import { Menu, X, LayoutDashboard, Globe, Mail, Share2, Tag, Briefcase, FlaskConical, Megaphone, CalendarDays } from 'lucide-react'
...
const navigation = [
  ...
  { name: 'Marketing Calendar', href: '/dashboard/calendar', icon: CalendarDays },
